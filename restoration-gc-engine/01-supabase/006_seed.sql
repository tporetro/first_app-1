...
--     "inflate the estimate to cover your deductible"; widened to .{0,40}.
...
('il_no_deductible','IL','pattern','\b(waive|absorb|inflate)\b.{0,40}\bdeductible\b',true,'block','IL 215 ILCS 5/155.51 / PA 098-0862 — deductible fraud prohibited.','Illinois law requires you to pay your deductible.','https://www.ilga.gov/legislation/ilcs/','content');
