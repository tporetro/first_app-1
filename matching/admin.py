...
class TargetAdmin(admin.ModelAdmin):
    list_display = ("owner_name", "entity_name", "phone", "email", "ticker", "city", "state", "damage_date", "match_status", "finding_count")
    list_filter = ("state", "damage_type")
    search_fields = ("owner_name", "entity_name", "ticker", "address", "city", "phone", "email")
